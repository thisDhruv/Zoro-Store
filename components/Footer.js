...
const Footer = () => {
  return (
<footer className="bg-white dark:bg-gray-900  w-full shadow-inner">
    <div className="mx-auto w-full container p-4 sm:p-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href={"/"} className="flex items-center">
                  <Image src={"/logotitle.png"} alt="FlowBite Logo" width={300} height={100}/>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      ...
                      <li>
                      <Link href={"/"} className="hover:underline">Apparels</Link>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="/" className="hover:underline">Zoro Store</Link>. All Rights Reserved.
          </span>
