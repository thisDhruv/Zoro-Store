...
const orders = () => {
  ...
  return (
    ...
    <h2 class="text-4xl font-extrabold dark:text-white text-center">Your Orders</h2>

        {

            orders && orders.map((order)=>{
                let cart = order.products;
                return <><div className='hover:bg-slate-100 p-4 mb-7 rounded-2xl'>
        ...
        }
        {
            (orders==null || orders.length==0) && <div className='m-auto mt-5'> 
                <h2 class="text-2xl font-extrabold dark:text-white">No Orders to Display</h2>
            </div>
        }
